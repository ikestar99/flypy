...
from ..utils.hyperstack import (
    saveTiffHyperstack, loadTiffHyperstack, savePillowArray, binStack)
...
def unpackLIF(lifFile, directory, idx):
    ...
    saveTiffHyperstack(directory.imgFile, hyperstack, shape="TZCYX")
...
def alignZPlanes(directories, ref, n=3):
    ...
    hyperstacks = [loadTiffHyperstack(d.imgFile) for d in directories]
...
def countFrames(directory):
    ...
    hyperstack = loadTiffHyperstack(directory.imgFile)
...
def binWithCountedFrames(directory, scalar=2):
    ...
    saveTiffHyperstack(directory.binFile, hyperstack, "TZCYX")
...
def makeMasks(directory, rowDict):
    ...
    """
    # mask = loadTiffHyperstack(directory.projFile)[0, 0, -1]
    # maskFile = Filepath(directory.maskDir, rowDict[MAIN["lay"]], ext="tif")
    # if not maskFile:
    #     saveTiffHyperstack(maskFile, mask, shape="YX")
    pass
